	...
	CREATE TABLE TAIKHOAN(
		...
		TK_Username NVARCHAR(255),
		TK_Password NVARCHAR(255),
		LoaiTK NVARCHAR(255)
	)

	CREATE TABLE THE_DOCGIA(
		MaDG NVARCHAR(255) PRIMARY KEY,
		HoTen NVARCHAR(255),
		MaTaiKhoan NVARCHAR(255) REFERENCES TAIKHOAN(MaTK),
	...
	CREATE TABLE SACH(
		...
		MaTheLoai NVARCHAR(255) REFERENCES THELOAI_SACH(MaTheLoai),
		TacGia NVARCHAR(255),
		NamXuatBan INT,
	...
	CREATE TABLE PHIEU_MUON_SACH(
		MaPhieuMuon NVARCHAR(255) PRIMARY KEY,
		MaDG NVARCHAR(255) REFERENCES THE_DOCGIA(MaDG),
		MaTT NVARCHAR(255) REFERENCES THUTHU(MaTT),
		SoLuongSach INT,
		NgayMuon SMALLDATETIME
	)

	CREATE TABLE PHIEU_TRA_SACH(
		MaPhieuTra NVARCHAR(255)  PRIMARY KEY,
		MaPhieuMuon NVARCHAR(255) REFERENCES PHIEU_MUON_SACH(MaPhieuMuon),
		MaDG NVARCHAR(255) REFERENCES THE_DOCGIA(MaDG),
		MaTT NVARCHAR(255) REFERENCES THUTHU(MaTT),
